...
const FloatingElements: React.FC<FloatingElementsProps> = ({ partyMode }) => {
  ...
  const GradientBlobs = () => (
    <div className="fixed inset-0 z-[-1] overflow-hidden">
      <div 
        className="absolute w-64 h-64 rounded-full bg-gradient-to-r from-pink-300 to-purple-300 opacity-30 blur-3xl"
        style={{ 
          top: '20%', 
          left: '10%',
      ...
      ></div>
      <div 
        className="absolute w-96 h-96 rounded-full bg-gradient-to-r from-yellow-300 to-orange-300 opacity-30 blur-3xl"
        style={{ 
          top: '60%', 
          left: '60%',
      ...
      ></div>
      <div 
        className="absolute w-72 h-72 rounded-full bg-gradient-to-r from-blue-300 to-teal-300 opacity-30 blur-3xl"
        style={{ 
          top: '30%', 
          right: '15%',
    ...
    <>
      ...
      {balloons.map(balloon => (
        ...
        >
          {/* Balloon string */}
          <div 
            className="absolute w-[2px] h-20 bg-gray-300 left-1/2 -translate-x-1/2 bottom-[-70px]"
            style={{
